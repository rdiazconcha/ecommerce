...
namespace ECommerce.Api.Products.Providers
{
    public class ProductsProvider : IProductsProvider
    {
        ...
        private void SeedData()
        {
            ...
            {
                dbContext.Products.Add(new Db.Product() { Id = 1, Name = "Keyboard", Price = 15, Inventory = 50 });
                dbContext.Products.Add(new Db.Product() { Id = 2, Name = "Mouse", Price = 10, Inventory = 100 });
                dbContext.Products.Add(new Db.Product() { Id = 3, Name = "Monitor", Price = 100, Inventory = 20 });
